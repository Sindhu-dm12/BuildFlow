...
def jira_request(method, path, params=None, timeout=15):
    """
...
@app.route('/api')
def api_info():
    return jsonify({"message": "UNCIA v3 API", "status": "running"}), 200
...
if __name__ == '__main__':
    ...
    print(f"🚀 UNCIA v3 starting on http://localhost:{port}")
